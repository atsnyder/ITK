...
template class itk::BoundingBox<unsigned long, 3, double, itk::MapContainer<unsigned long, itk::Point<double, 3u> > >; //Instantiated 24 times
...
template class itk::BoundingBox<unsigned long, 3, float, itk::MapContainer<unsigned long, itk::Point<float, 3u> > >; //Instantiated 18 times
template class itk::BoundingBox<unsigned long, 2, double, itk::MapContainer<unsigned long, itk::Point<double, 2u> > >; //Instantiated 18 times
