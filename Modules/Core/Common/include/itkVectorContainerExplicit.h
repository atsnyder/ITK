...
extern template class itk::VectorContainer<unsigned long, itk::Point<float, 4u> >;
...
extern template class itk::VectorContainer<unsigned long, vnl_vector<double> >;
...
extern template class itk::VectorContainer<long, itk::Array<unsigned long> >;
extern template class itk::VectorContainer<unsigned int, float>;
extern template class itk::VectorContainer<long, itk::Array<long> >;
...
extern template class itk::VectorContainer<unsigned long, long>;
