...
extern template class itk::VariableLengthVector<float>;
extern template class itk::VariableLengthVector<long>;
extern template class itk::VariableLengthVector<short>;
