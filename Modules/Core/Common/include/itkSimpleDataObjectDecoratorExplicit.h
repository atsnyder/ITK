...
//exclude Statistics::
//subs std:: std::
extern template class itk::SimpleDataObjectDecorator<unsigned long>;
...
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<short> >;
extern template class itk::SimpleDataObjectDecorator<unsigned char>;
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<unsigned long> >;
extern template class itk::SimpleDataObjectDecorator<itk::Point<double, 2u> >;
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<unsigned short> >;
extern template class itk::SimpleDataObjectDecorator<double>;
extern template class itk::SimpleDataObjectDecorator<char>;
...
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<int> >;
extern template class itk::SimpleDataObjectDecorator<std::complex<double> >;
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<signed char> >;
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<unsigned int> >;
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<long> >;
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<unsigned char> >;
extern template class itk::SimpleDataObjectDecorator<itk::Array<float> >;
extern template class itk::SimpleDataObjectDecorator<signed char>;
extern template class itk::SimpleDataObjectDecorator<itk::Vector<float, 1u> >;
extern template class itk::SimpleDataObjectDecorator<std::basic_string<char, std::char_traits<char>, std::allocator<char> > >;
extern template class itk::SimpleDataObjectDecorator<itk::VariableLengthVector<double> >;
...
extern template class itk::SimpleDataObjectDecorator<long>;
