 ...
 *
 *=========================================================================*/
#ifndef __itkBoundingBoxExplicit_h
#define __itkBoundingBoxExplicit_h
...
extern template class itk::BoundingBox<unsigned long, 4, float, itk::VectorContainer<unsigned long, itk::Point<float, 4u> > >;
...
#endif //__itkBoundingBoxExplicit_h
