 ...
 *
 *=========================================================================*/
#ifndef __itkSpatialObjectWriterExplicit_h
#define __itkSpatialObjectWriterExplicit_h
...
extern template class itk::SpatialObjectWriter<3u, unsigned short, itk::DefaultStaticMeshTraits<unsigned short, 3u, 3u, float, float, unsigned short> >;
...
#endif //__itkSpatialObjectWriterExplicit_h
