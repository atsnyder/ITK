 ...
 *
 *=========================================================================*/
#ifndef __itkMattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader_h
#define __itkMattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader_h
...
/** \class MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader
 * \brief Processes points for MattesMutualInformationSingleThreadedImageToImageMetricv4 \c
...
public:
  ...
  typedef MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader                                      Self;
  ...
  itkTypeMacro( MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader, ImageToImageMetricv4GetValueAndDerivativeThreader );
...
protected:
  MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader() :
  ...
  virtual void ComputePDFDerivativesGlobalSupportTransform(const OffsetValueType &         fixedImageParzenWindowIndex,
...
private:
  MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader( const Self & ); // purposely not implemented
...
#include "itkMattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader.hxx"
#endif
