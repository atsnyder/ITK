 ...
 *
 *=========================================================================*/
#ifndef __itkMattesMutualInformationSingleThreadedImageToImageMetricv4_h
#define __itkMattesMutualInformationSingleThreadedImageToImageMetricv4_h

#include "itkImageToImageMetricv4.h"
#include "itkMattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader.h"
#include "itkPoint.h"
#include "itkIndex.h"
...
/** \class MattesMutualInformationSingleThreadedImageToImageMetricv4
 *
 * \brief Computes the mutual information between two images to be
 * registered using the method of Mattes et al.  The SingleThreaded
 * version is substantially the same as the MultiThreaded
 * implementation, but without the per-thread partial result member
 * variables.
 *
 ...
 *
 * See
 *  MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader::ProcessPoint
...
public:
  ...
  typedef MattesMutualInformationSingleThreadedImageToImageMetricv4                      Self;
  ...
  itkTypeMacro(MattesMutualInformationSingleThreadedImageToImageMetricv4, ImageToImageMetricv4);
  ...
  /** Single threaded, so redefine these methods to reflect */
  virtual void SetMaximumNumberOfThreads(const ThreadIdType threads);
  virtual ThreadIdType GetMaximumNumberOfThreads() const { return 1; }
...
protected:
  ...
  virtual ~MattesMutualInformationSingleThreadedImageToImageMetricv4();

  friend class MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< Superclass::VirtualImageDimension >, Superclass, Self >;
  friend class MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader< ThreadedIndexedContainerPartitioner, Superclass, Self >;
  typedef MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< Superclass::VirtualImageDimension >, Superclass, Self >
    MattesMutualInformationDenseGetValueAndDerivativeThreaderType;
  typedef MattesMutualInformationSingleThreadedImageToImageMetricv4GetValueAndDerivativeThreader< ThreadedIndexedContainerPartitioner, Superclass, Self >
  ...
  mutable std::vector<PDFValueType> m_ThreaderFixedImageMarginalPDF;
...
private:
  MattesMutualInformationSingleThreadedImageToImageMetricv4(const Self &); //purposely not implemented
...
#include "itkMattesMutualInformationSingleThreadedImageToImageMetricv4.hxx"
#endif
